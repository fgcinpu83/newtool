...
// Generate 100 AFB88 matches for testing hundreds dataset processing
function generateMatches(count) {
  ...
  const teams = [
    "Manchester City", "Manchester United", "Arsenal", "Chelsea", "Liverpool", "Tottenham", "Newcastle", "Aston Villa",
    "Barcelona", "Real Madrid", "Atletico Madrid", "Valencia", "Sevilla", "Villarreal", "Betis", "Athletic Bilbao",
    "Bayern Munich", "Borussia Dortmund", "RB Leipzig", "Bayer Leverkusen", "Wolfsburg", "Eintracht Frankfurt", "Schalke", "Stuttgart",
    "Juventus", "Inter Milan", "AC Milan", "Roma", "Napoli", "Lazio", "Fiorentina", "Torino",
    "PSG", "Marseille", "Lyon", "Monaco", "Lille", "Nice", "Lens", "Rennes",
    "Ajax", "PSV Eindhoven", "Feyenoord", "AZ Alkmaar", "Utrecht", "Groningen", "Vitesse", "Twente",
    "Porto", "Benfica", "Sporting CP", "Braga", "Vitoria SC", "Boavista",
  ...
  for (let i = 0; i < count; i++) {
    ...
    matches.push({
      "MatchId": `20996${String(100 + i).slice(-3)}`,
...
// AFB88 Test Data with 100 matches
const afbTestData100 = {
  "error": "",
...
const payload = {
  ...
  account: 'B',
  responseBody: JSON.stringify(afbTestData100),
  clientId: 'AFB88-TEST-100'
};
...
console.log('Sending 100 AFB88 matches via HTTP POST...');
